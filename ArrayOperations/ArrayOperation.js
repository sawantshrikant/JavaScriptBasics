...
//The forEach method iterates through the elements of an array and applies a callback function to each element.
//It doesn't create a new array; instead, it's used for performing some action on each element of the existing array.
const fruits15 = ['apple', 'banana', 'cherry'];

fruits15.forEach((fruit) => {
  console.log(fruit);
});
